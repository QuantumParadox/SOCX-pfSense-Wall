...
Environment=SOCX_PI_LLM_TIMEOUT=${SOCX_PI_LLM_TIMEOUT:-15}
Environment=SOCX_PI_HAILO_CHAT_URL=${SOCX_PI_HAILO_CHAT_URL:-http://127.0.0.1:8000/api/chat}
Environment=SOCX_PI_HAILO_TIMEOUT=${SOCX_PI_HAILO_TIMEOUT:-8}
Environment=SOCX_PI_ROLE_MAX_SECONDS=${SOCX_PI_ROLE_MAX_SECONDS:-24}
Environment=SOCX_PI_TOTAL_TIMEOUT=${SOCX_PI_TOTAL_TIMEOUT:-80}
...
Environment=SOCX_PI_OLLAMA_KEEP_ALIVE=${SOCX_PI_OLLAMA_KEEP_ALIVE:-15m}
Environment=SOCX_PI_WARM_CPU_MODELS=${SOCX_PI_WARM_CPU_MODELS:-false}

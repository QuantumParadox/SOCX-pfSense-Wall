...
#   SOCX_TICKER_INTERVAL_MS=50
#   SOCX_TICKER_MAX_EVENTS=25
#   SOCX_TICKER_DEDUPE_SECONDS=10
export SOCX_TICKER_SPEED="${SOCX_TICKER_SPEED:-turbo}"
export SOCX_TICKER_STEP="${SOCX_TICKER_STEP:-6}"
export SOCX_TICKER_INTERVAL_MS="${SOCX_TICKER_INTERVAL_MS:-50}"
